...
function BookScheduleModal({ isOpen, onClose, onScheduleBooked }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setError('Đặt lịch thất bại: ' + (err.response?.data || err.message));
    }
  };
      ...
      >
        ...
        >
          <div className="modal-header border-0 pb-2 justify-content-center">
            <h5 className="modal-title fw-bold text-primary text-center w-100" style={{ fontSize: '1.5rem', letterSpacing: 1 }}>Đặt lịch</h5>
          </div>
          ...
          <div className="modal-footer border-0 pt-2 justify-content-end">
            ...
            <button type="button" className="btn btn-primary rounded-pill px-4" onClick={handleSubmit}>Đặt lịch</button>
          </div>
        </div>
      </div>
    </div>
